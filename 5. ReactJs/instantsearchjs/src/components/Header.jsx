  ...
  return (
    <header className="header">
      <p className="header-logo">
        <a href="https://algolia.com" aria-label="Go to the Algolia website" target="_blank" rel="noreferrer">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 117" width="92" height="24">
            <path
              fill="#FFF"
      ...
      <div className="ais-SearchBox">
        <form className="ais-SearchBox-form" action="" role="search" onSubmit={(e) => e.preventDefault()}>
          ...
          <button className="ais-SearchBox-submit" type="submit" title="Submit the search query.">
            <svg className="ais-SearchBox-submitIcon" width="10" height="10" viewBox="0 0 40 40">
              <path
                fill="currentColor"
                d="M26.804 29.01c-2.832 2.34-6.465 3.746-10.426 3.746C7.333 32.756 0 25.424 0 16.378 0 7.333 7.333 0 16.378 0c9.046 0 16.378 7.333 16.378 16.378 0 3.96-1.406 7.594-3.746 10.426l10.534 10.534c.607.607.61 1.59-.004 2.202-.61.61-1.597.61-2.202.004L26.804 29.01zm-10.426.627c7.323 0 13.26-5.936 13.26-13.26 0-7.323-5.937-13.26-13.26-13.26-7.324 0-13.26 5.937-13.26 13.26 0 7.324 5.936 13.26 13.26 13.26z"
              />
            </svg>
          </button>
          {query && (
            ...
            >
              <svg className="ais-SearchBox-resetIcon" width="10" height="10" viewBox="0 0 20 20">
                <path
                  fill="currentColor"
